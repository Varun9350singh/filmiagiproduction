const team = [
  {
    ...
    description:[
        ...
        "Her leadership, communication skills, and commitment make her an essential part of the team. Tarushi continues to contribute significantly to the growth and success of Filmiagi Production."
    ],
    contact: {
  ...
  },
  {
    ...
    description:[
        ...
        "More than a co-founder, she is the strength that brings balance, structure, and stability to the team. Her passion and commitment continuously push Filmiagi Production towards new heights. Without her, the growth and smooth functioning of the brand would not be possible."
    ],
    contact: {
      email: "filmiagiproduction@gmail.com",
      instagram: "@filmiagiproduction | @mrmissmrslucknow.official",
  ...
  },
  {
    ...
    description:[
        ...
        "With a strong presence in both Delhi and Lucknow fashion circuits, Abhishek has built an influential network and reputation. His events are known for their grand scale, premium quality, and flawless execution.",
        "Fearless in taking risks and introducing fresh concepts, he continues to set new trends in the industry. His confidence, leadership, and ability to inspire others make him a true game-changer. Today, the success and recognition of Filmiagi Production stand as a reflection of his dedication, hard work, and clear vision."
    ],
    contact: {
      email: "filmiagiproduction@gmail.com",
